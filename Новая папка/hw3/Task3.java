// Задача 3. Определение количества букв "о" в первом слове предложения
public class Task3 {
    public static void main(String[] args) {
        String sentence = "   Образец предложения, в котором нужно посчитать буквы о."; // Пример предложения
